...
function getversion(){
    $versions=gettable('site_data','version_updates');
    $current_version=end($versions);
    $number=$current_version['id'];
    return $number;
...
function zmaninm(){
    $path = "http://www.chabad.org/tools/rss/zmanim.xml?locationId=300&locationType=1&bDef=0&before=18";
